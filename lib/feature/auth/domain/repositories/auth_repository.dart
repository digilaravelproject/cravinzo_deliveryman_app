...
class AuthRepository implements AuthRepositoryInterface {
  ...
  Future<Response> updateToken({String notificationDeviceToken = ''}) async {
    ...
    // Added for debugging: Print rider token
    debugPrint('\n\n\n\n=======================================================\n');
    debugPrint('RIDER TOKEN: $deviceToken');
    debugPrint('\n=======================================================\n\n\n');
    // Also show in SnackBar for convenience
    // Note: showCustomSnackBar needs importing, but for quick debugging print is safer first.
    // If I import showCustomSnackBar, I need to make sure the package name is correct.
    // I will stick to logging for now to avoid compilation errors if import is tricky.
    // However, the user asked for it, likely they can't see logs easily?
    // I will try to add the import first.
    debugPrint('--------Delivery Man App FCM Token---------- $deviceToken');
