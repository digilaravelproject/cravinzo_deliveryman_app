class ProfileModel {
  ...
  ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    rideDistance = json['ride_distance']?.toDouble();
    rideDistancePay = json['ride_distance_pay']?.toDouble();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ride_distance'] = rideDistance;
    data['ride_distance_pay'] = rideDistancePay;
    return data;
  }
}
