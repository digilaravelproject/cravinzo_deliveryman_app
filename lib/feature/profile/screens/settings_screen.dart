            ...
            GetPlatform.isAndroid ? InkWell(
              ...
              child: DetailsCustomCard(
                ...
                child: Row(children: [
                  ...
                  Icon(Icons.notifications_active_rounded, size: 25, color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)),
  ...
  void showBgNotificationBottomSheet(bool allow) {
    Get.bottomSheet(Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(
          allow ? '(${AppConstants.appName} -> Battery -> Select Optimized)' : '(${AppConstants.appName} -> Battery -> Select No Restriction)',
          textAlign: TextAlign.center,
