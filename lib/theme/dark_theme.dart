...
ThemeData dark = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF407a33))), colorScheme: const ColorScheme.dark(primary: Color(0xFF407a33), secondary: Color(0xFF407a33)).copyWith(error: const Color(0xFFdd3135)),
